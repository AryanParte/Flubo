    ...
    <section className="section-padding pt-32 md:pt-40 overflow-hidden">
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col items-center text-center">
          <span className="inline-flex items-center rounded-full border border-green-300/60 bg-green-50/30 px-3 py-1 text-sm font-medium text-foreground/80 mb-6 animate-fade-in">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight animate-slide-up" style={{ animationDelay: "100ms" }}>
            ...
            <span className="bg-gradient-to-r from-green-500 via-teal-500 to-green-400 bg-clip-text text-transparent">With AI-Powered Matching</span>
          </h1>
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 animate-slide-up" style={{ animationDelay: "300ms" }}>
            ...
            <Button asChild variant="outline" className="w-full sm:w-auto border-teal-500 text-teal-600 hover:bg-teal-50/30">
          ...
          <div className="mt-24 max-w-5xl w-full">
            <div className="relative w-full h-[350px] sm:h-[450px] md:h-[500px] rounded-2xl overflow-hidden animate-scale-in">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-green-500/20 via-teal-300/10 to-teal-500/20 dark:bg-gradient-to-br dark:from-green-500/20 dark:via-teal-300/10 dark:to-teal-500/20 border border-green-500/20 dark:border-white/10"></div>
                  ...
                  <div className="mt-8 grid grid-cols-2 gap-6 w-full">
                    ...
                    <div className="bg-white dark:bg-white/10 rounded-lg p-4 h-48 border border-gray-100 dark:border-white/5">
                      <div className="h-full flex flex-col justify-center items-center space-y-4">
                        <div className="w-16 h-16 rounded-full bg-gradient-to-br from-green-500/30 to-teal-500/30 dark:from-green-500/30 dark:to-teal-500/30 flex items-center justify-center">
                        ...
                        <Button variant="outline" size="sm" className="text-xs border-teal-500 text-teal-600 hover:bg-teal-500/10 mt-2">
