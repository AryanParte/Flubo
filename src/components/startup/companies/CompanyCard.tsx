      ...
      >
        ...
        <div className="p-6 flex-1 flex flex-col">
          <div className="flex justify-between items-start mb-3">
            <h3 className="font-semibold text-xl truncate mr-2">{company.name}</h3>
          ...
          <p className="text-sm text-muted-foreground mb-4 line-clamp-2">{company.bio || company.tagline || 'No description available'}</p>
